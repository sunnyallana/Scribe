...
export const latexCommands: readonly LatexCommandDef[] = [
  // Sectioning
  { name: '\\chapter', template: '\\chapter{#1}', description: 'Top-level section', category: 'sectioning' },
  { name: '\\section', template: '\\section{#1}', description: 'Section', category: 'sectioning' },
  { name: '\\subsection', template: '\\subsection{#1}', description: 'Subsection', category: 'sectioning' },
  { name: '\\subsubsection', template: '\\subsubsection{#1}', description: 'Subsubsection', category: 'sectioning' },
  { name: '\\paragraph', template: '\\paragraph{#1}', description: 'Paragraph heading', category: 'sectioning' },

  // Document
  { name: '\\documentclass', template: '\\documentclass{#1}', description: 'Document class', category: 'preamble' },
  { name: '\\usepackage', template: '\\usepackage{#1}', description: 'Load a package', category: 'preamble' },
  ...
  { name: '\\begin', template: '\\begin{#1}', description: 'Begin environment', category: 'environments' },
  { name: '\\end', template: '\\end{#1}', description: 'End environment', category: 'environments' },

  // Refs / cites / labels
  { name: '\\label', template: '\\label{#1}', description: 'Define a label', category: 'cross-refs' },
  { name: '\\ref', template: '\\ref{#1}', description: 'Cross-reference', category: 'cross-refs' },
  { name: '\\eqref', template: '\\eqref{#1}', description: 'Equation reference', category: 'cross-refs' },
  { name: '\\pageref', template: '\\pageref{#1}', description: 'Page reference', category: 'cross-refs' },
  { name: '\\cite', template: '\\cite{#1}', description: 'Citation', category: 'cross-refs' },
  { name: '\\bibliography', template: '\\bibliography{#1}', description: 'Bibliography source', category: 'cross-refs' },
  { name: '\\bibliographystyle', template: '\\bibliographystyle{#1}', description: 'Bibliography style', category: 'cross-refs' },
  ...
  { name: '\\textit', template: '\\textit{#1}', description: 'Italic text', category: 'formatting' },
  { name: '\\emph', template: '\\emph{#1}', description: 'Emphasized text', category: 'formatting' },
  { name: '\\texttt', template: '\\texttt{#1}', description: 'Typewriter text', category: 'formatting' },
  { name: '\\underline', template: '\\underline{#1}', description: 'Underlined text', category: 'formatting' },

  // Lists / tables / figures
  { name: '\\item', template: '\\item #1', description: 'List item', category: 'lists' },
  { name: '\\caption', template: '\\caption{#1}', description: 'Figure/table caption', category: 'figures' },
  { name: '\\includegraphics', template: '\\includegraphics[width=#1]{#2}', description: 'Include image', category: 'figures' },
  ...
  { name: '\\include', template: '\\include{#1}', description: 'Include file (new page)', category: 'misc' },
